<?php
session_start();
// Sertakan file-file yang dibutuhkan
...
if (isset($_POST['cetak']) && isset($_SESSION['level']) && $_SESSION['level'] == 'Admin') {
    ...
    // --- Hapus Garis Horizontal & Beri Jarak ---
    // Baris $pdf->Line(...) yang lama sudah dihapus.
    // Beri jarak vertikal yang cukup besar sebelum konten utama.
    $pdf->Ln(5);
    ...
    // Anda juga bisa redirect ke halaman login
